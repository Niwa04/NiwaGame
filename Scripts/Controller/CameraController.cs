...
namespace TPCWC
{
	public class CameraController : MonoBehaviour 
	{
		...
		public void FixedUpdate(){
			...
			try{			RotateCamera(Time.deltaTime, vertical, horizontal, camTargetSpeed);
			}catch{}
		}

		public void RotateCamera(float vert, float horz){
			RotateCamera(Time.deltaTime, vert, horz,mouseSpeed);
		}
